...
* [debugInfo](#debuginfo) - Log Debug Info
...
async function run() {
  ...
  const result = await sdk.manage.publish();
...
async function run() {
  ...
  const result = await sdk.manage.health();
...
async function run() {
  ...
  const result = await sdk.manage.status();
...
async function run() {
  ...
  const result = await sdk.manage.debugInfo();
...
**Promise<[operations.DebugInfoResponse](../../models/operations/debuginforesponse.md)>**
### Errors
